...
- Home hero video (`assets/hero.mp4`, poster `assets/hero.jpg`): "Mountains, Dolomites, Cadini Di Misurina" by ferrisdrone, [Pixabay](https://pixabay.com/videos/mountains-dolomites-137822/), Pixabay Content License (free commercial use, no attribution required). Re-encoded to H.264 without audio.
